...
return [
    ...
    */
    ...
    'before_or_equal' => 'The विशेषता: must be a date before or equal to :date.',
    'between'         => [
        'numeric' => 'विशेषता::attribute :min र :max को बिचमा हुनुपर्छ।',
        'file'    => 'विशेषता::attribute :min र :max kilobytes को बिचमा हुनुपर्छ।',
        'string'  => 'विशेषता::attribute :min र :max वर्णको बिचमा हुनुपर्छ।',
        'array'   => 'विशेषता::attribute मा आइटमको संख्या :min र :max को बिचमा हुनुपर्छ।',
    ],
    'boolean'        => 'विशेषता: ठिक अथवा बेठिक हुनुपर्छ।',
    'confirmed'      => 'विशेषता: दाेहाेर्याइएकाे मिलेन।',
    'date'           => 'विशेषता: को मिति मिलेन।',
    'date_equals'    => 'विशेषता:bute must be a date equal to :date.',
